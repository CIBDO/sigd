                        ...
                        <div class="slider-product-details">
                            <div class="owl-carousel owl-theme product-slide owl-loaded owl-drag">
                                ...
                                <div class="owl-stage-outer">
                                    <div class="owl-stage"
                                         style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1108px;">
                                        <div class="owl-item active" style="width: 523.992px; margin-right: 30px;">
                                        ...
                                        <div class="owl-item" style="width: 523.992px; margin-right: 30px;">
                                            <div class="slider-product">
                                                <img src="assets/img/product/product69.jpg" alt="img">
                                                <h4>macbookpro.jpg</h4>
                                                <h6>581kb</h6>
